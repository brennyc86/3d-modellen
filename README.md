...
| [`airtag-kattentuig`](airtag-kattentuig/) | Houder voor een Ø35 × 8 mm tracker aan een kattentuigje. Eén stuk TPU, geen support en nergens een brug: tag onder een 2,2 mm lip, twee uitstulpingen met een rechtopstaand riemgat van 15 × 8 mm. Alle randen ruim afgerond, met een lange aanloop aan de kant van de kat. | ✅ v6 |
